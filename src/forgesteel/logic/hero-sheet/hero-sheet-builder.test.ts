...
import { FeatureCompanion, FeatureFollower, FeatureRetainer, FeatureSummonChoice, FeatureSummonChoiceData } from '@/forgesteel/models/feature';
...
import { FollowerSheet } from '@/forgesteel/models/classic-sheets/hero-sheet';
...
import { HeroSheetBuilder } from '@/forgesteel/logic/hero-sheet/hero-sheet-builder';
...
import { highElfTactician } from '@/forgesteel/data/heroes/high-elf-tactician';
import { retainer } from '@/forgesteel/data/monsters/retainer';
import { undead } from '@/forgesteel/data/classes/summoner/undead';
...
describe('buildSummonSheet', () => {
	vi.mock('@/forgesteel/logic/hero-logic', () => {
...
describe('buildHeroSheet', () => {
	vi.unmock('@/forgesteel/logic/hero-logic');
